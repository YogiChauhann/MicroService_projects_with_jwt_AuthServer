...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	private static final String COUPONSERVICE_resourceId = "couponservice";
...
//		endpoints.tokenStore(new JdbcTokenStore(dataSource)).authenticationManager(authenticationManager)
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		...
		.authorizedGrantTypes("password","refresh_token").scopes("read","write").resourceIds(COUPONSERVICE_resourceId);
	}
...
//		jwtAccessTokenConverter.setKeyPair(keyPair);
		...
		jwtAccessTokenConverter.setSigningKey("testSymmetricKey");
